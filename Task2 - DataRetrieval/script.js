...
const records = [
    { name: "Bruce", department: "IT", date: "2024-01-10" },
    { name: "Thor", department: "HR", date: "2023-11-22" },
    { name: "Tony", department: "IT", date: "2024-02-01" },
    { name: "Stark", department: "Finance", date: "2023-12-15" },
    { name: "Steve", department: "HR", date: "2024-01-05" }
];
