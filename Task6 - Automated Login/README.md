...
-- Description: 
    This task demonstrates automated audit logging using database TRIGGERS and reporting using VIEWS. Every INSERT and UPDATE operation is logged automatically , and a daily activity report is generated using a VIEW.
